...
# Use the model
model.train(data="/home/juliofgx/PycharmProjects/PadelClips/dataset/padel_pove/2set/2set_1/train/data.yaml", epochs=200, imgsz=3840, device=0, batch=2, workers=8)  # train the model
