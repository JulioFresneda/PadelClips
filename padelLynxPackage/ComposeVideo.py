...
from padelLynxPackage import Game

from pptx import Presentation

from padelLynxPackage.aux import extract_frame_from_video, crop_and_save_image
...
class ComposeVideo:
    ...
    def cook_pptx_player(self, tag):
        ...
        shots = self.game.gameStats.player_shots(tag)
...
def json_points_to_video(points_json, input_video_path, output_video_path, from_path = None):
    ...
    for key, frames in points.items():
        ...
        temp_clip_path = f"temp_clip_{key}.mp4"
        extract_clip(input_video_path, frames[0], frames[1], temp_clip_path, key)
